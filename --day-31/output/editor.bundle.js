(function () {
   ...
   */
   ...
   const parser = LRParser.deserialize({
     version: 14,
     states: "!|QYQPOOOeQPO'#C_OmQPO'#CbOOQO'#Ch'#ChOOQO'#Cc'#CcQYQPOOOOQO'#Cd'#CdO{QPO,58yOOQO,58y,58yOOQO,58|,58|O!TQPO,58|OOQO-E6a-E6aOOQO-E6b-E6bOOQO1G.e1G.eOOQO1G.h1G.h",
     stateData: "!c~OZOSPOS~OTQO]RO_PO~O]UO^WO~OSXOTQO]RO_PO~O]UO^]O~OS^OTQO]RO_PO~O",
     goto: "z]PPP^PP^dnPPPtXROQTYQTOQYQTZTYQVPR[VXSOQTY",
     nodeNames: "⚠ Comment Program CommentExpression } { Application",
     maxTerm: 15,
     nodeProps: [
       ["openedBy", 4,"{"],
       ["closedBy", 5,"}"]
     ...
     skippedNodes: [0,1],
     repeatNodeCount: 2,
     tokenData: "#X~RXXYnYZn]^npqnz{!P!O!P![!P!Q!d#o#p!}#q#r#S~sSZ~XYnYZn]^npqn~!SP!P!Q!V~![O^~~!aP]~!O!P![~!gQz{!m!P!Q!r~!rO_~~!wQP~OY!rZ~!r~#SOT~~#XOS~",
     tokenizers: [0],
